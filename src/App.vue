        ...
        <div class="app-container">
                ...
                <div class="card">
                        <button @click="async () => {
                                ...
                                const responseMessage = await rpc.call('greet', { name: 'Neymar' });
                        ...
                        <button @click="() => baseAPI.close()">Close</button>
                </div>

                <div class="info-section">
                        <p class="message">{{ message }}</p>
                        <a href="https://pyloid.com" rel="noopener noreferrer"> Visit Pyloid </a>
                </div>
        </div>
</template>
